document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll(".input-form-title").forEach(title => {
        title.addEventListener("input", function(){
            ...
            document.title = `${this.value} - Dazzle Forms`
                            ...
                            if(this.value === "multiple choice" || this.value === "checkbox"){
                                ...
                                .then(result => {
                                    ...
                                    <div class="choice">
                                        ...
                                        data-type = "${this.value}">Добавить вариант</label>
                                    </div>`;
    ...
    document.querySelector("#add-question").addEventListener("click", () => {
        ...
        .then(result => {
            ...
            <div class="choice-option">
                <label class="toggle-switch" for="${result["question"].id}">
                    <input type="checkbox" class="required-checkbox" id="${result["question"].id}" data-id="${result["question"].id}">
                    <span class="toggle-slider"></span>
                </label>
                <label for="${result["question"].id}" class="required">Обязателен*</label>
                <div class="float-right">
                    <img src="/static/Icon/black-delete.png" alt="Delete question icon" class="question-option-icon delete-question" title="Удалить поле"
